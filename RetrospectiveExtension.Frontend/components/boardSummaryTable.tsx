...
export class BoardSummaryTable extends React.Component<IBoardSummaryTableProps, IBoardSummaryTableState> {
    ...
    private setBoardsTable = async () => {
        ...
        this.setState(() => {
            let boardsTableItems = new Array<IBoardSummaryTableItem>();
            let actionItems: IActionItemsTableItems = {};
    ...
    private setBoardStats = async (feedbackBoardId: string) => {
        ...
        await Promise.all(feedbackItems.map(async (feedbackItem) => {
            ...
            this.setState(prevState => {
                let updatedActionItemsForBoard = prevState.actionItemsByBoard[feedbackBoardId];
                let updatedItems = updatedActionItemsForBoard.actionItems.concat(workItems);
