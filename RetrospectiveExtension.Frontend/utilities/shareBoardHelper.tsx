...
class ShareBoardHelper {
  ...
  public generateCSVContent = async (board: IFeedbackBoardDocument) => {
    ...
    let content: string = `Retrospectives Summary for ${board.title}\n`;
    content += "Type,Description,Votes, DateCreated. Created By, Link\n"

    content += await this.getFeedbacksCSV(feedbackItems, board.columns);
  ...
  private async getFeedbacksCSV(feedbackItems: IFeedbackItemDocument[], columns: IFeedbackColumn[]): Promise<string> {
