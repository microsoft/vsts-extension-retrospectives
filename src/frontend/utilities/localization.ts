...
const translations = {
  en: {
    ...
    feedback_board_link_copy_failed: "Failed to copy retrospective link to clipboard. Please try again.",
    feedback_board_email_copied: "The email summary for \"{{title}}\" has been copied to your clipboard.",
    feedback_board_email_copy_failed: "Failed to copy email summary to clipboard. Please try again.",
    feedback_board_email_ctrlc_to_copy: "Text selected — press Ctrl+C (or Cmd+C) to copy.",
    feedback_board_copy_link_dialog_title: "Copy retrospective link",
  ...
  es: {
    ...
    feedback_board_link_copy_failed: "Error al copiar el enlace de la retrospectiva al portapapeles. Intentalo de nuevo.",
    feedback_board_email_copied: "El resumen por correo de \"{{title}}\" se copio a tu portapapeles.",
    feedback_board_email_copy_failed: "Error al copiar el resumen por correo al portapapeles. Intentalo de nuevo.",
    feedback_board_email_ctrlc_to_copy: "Texto seleccionado — pulsa Ctrl+C (o Cmd+C) para copiar.",
    feedback_board_copy_link_dialog_title: "Copiar enlace de retrospectiva",
  ...
  de: {
    ...
    feedback_board_link_copy_failed: "Fehler beim Kopieren des Retrospektive-Links in die Zwischenablage. Versuchen Sie es erneut.",
    feedback_board_email_copied: "Die E-Mail-Zusammenfassung fuer \"{{title}}\" wurde in Ihre Zwischenablage kopiert.",
    feedback_board_email_copy_failed: "Fehler beim Kopieren der E-Mail-Zusammenfassung in die Zwischenablage. Versuchen Sie es erneut.",
    feedback_board_email_ctrlc_to_copy: "Text ausgewaehlt — druecken Sie Strg+C (oder Cmd+C), um zu kopieren.",
    feedback_board_copy_link_dialog_title: "Retrospektive-Link kopieren",
  ...
  fr: {
    ...
    feedback_board_link_copy_failed: "Erreur lors de la copie du lien de retrospective dans le presse-papiers. Veuillez reessayer.",
    feedback_board_email_copied: "Le resume par e-mail de \"{{title}}\" a ete copie dans votre presse-papiers.",
    feedback_board_email_copy_failed: "Erreur lors de la copie du resume par e-mail dans le presse-papiers. Veuillez reessayer.",
    feedback_board_email_ctrlc_to_copy: "Texte selectionne — appuyez sur Ctrl+C (ou Cmd+C) pour copier.",
    feedback_board_copy_link_dialog_title: "Copier le lien de retrospective",
