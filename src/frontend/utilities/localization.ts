...
const translations = {
  en: {
    ...
    feedback_board_view_only_message: "You can view settings, but only the Board Owner or a Team Admin can make changes.",
  ...
  es: {
    ...
    feedback_board_view_only_message: "Puedes ver la configuracion, pero solo el propietario del tablero o un administrador del equipo pueden hacer cambios.",
  ...
  de: {
    ...
    feedback_board_view_only_message: "Sie koennen Einstellungen anzeigen, aber nur der Boardbesitzer oder ein Teamadministrator kann Aenderungen vornehmen.",
  ...
  fr: {
    ...
    feedback_board_view_only_message: "Vous pouvez consulter les parametres, mais seul le proprietaire du tableau ou un administrateur d'equipe peut apporter des modifications.",
