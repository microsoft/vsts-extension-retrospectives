...
const translations = {
  en: {
    ...
    sprint_retro_menu_label: "Sprint retrospective",
    sprint_retro_create_current: "Create for current sprint",
    sprint_retro_create_selected: "Create for selected sprint",
    sprint_retro_dialog_title: "Create sprint retrospective",
    sprint_retro_dialog_description: "Choose a sprint and create or open its corresponding retrospective board.",
    sprint_retro_dialog_selector_label: "Sprint",
    sprint_retro_current_not_found: "No current sprint is configured for this team.",
    sprint_retro_no_iterations: "No sprints are configured for this team yet.",
    sprint_retro_created: "Opened retrospective {{title}} for sprint {{iteration}}.",
    sprint_retro_exists: "Sprint {{iteration}} already has retrospective {{title}}.",
    sprint_retro_error: "We could not create a retrospective for sprint {{iteration}}.",
    sprint_retro_panel_title: "Sprint retrospective",
    sprint_retro_panel_description: "Create or open the retrospective board that matches the sprint you are viewing.",
    sprint_retro_panel_error: "We could not load sprint context for this page.",
    sprint_retro_panel_ready: "Ready to create a retrospective board for this sprint.",
    sprint_retro_panel_exists: "Existing retrospective: {{title}}",
    sprint_retro_create_button: "Create retrospective board",
    sprint_retro_open_button: "Open retrospective board",
    sprint_retro_team_label: "Team",
    sprint_retro_iteration_label: "Sprint",
    sprint_retro_dates_label: "Sprint dates",
    sprint_retro_dates_unavailable: "Sprint dates are not configured.",
    sprint_retro_status_label: "Status",
  },
  es: {
