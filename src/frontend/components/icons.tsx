...
export const SettingsIcon = () => {
  return (
    <svg className="icon-settings" xmlns="http://www.w3.org/2000/svg" height="24" viewBox="0 0 24 24" width="24" fill="currentColor">
      <path d="M0 0h24v24H0V0z" fill="none" />
      <path d="M19.14 12.94c.04-.3.06-.61.06-.94 0-.32-.02-.64-.07-.94l1.72-1.35c.15-.12.19-.34.1-.51l-1.63-2.83c-.12-.22-.37-.29-.59-.22l-2.03.81c-.42-.32-.9-.6-1.42-.82L14.4 2.87c-.04-.25-.25-.43-.5-.43h-3.26c-.25 0-.46.18-.49.43L9.13 5.14c-.52.23-1 .5-1.42.82L5.68 5.15c-.22-.09-.47 0-.59.22L2.46 8.2c-.1.16-.06.39.1.51l1.72 1.35c-.05.3-.07.62-.07.94 0 .33.02.64.07.94L2.56 14.29c-.15.12-.19.34-.1.51l1.63 2.83c.12.22.37.29.59.22l2.03-.81c.42.32.9.6 1.42.82l.3 2.16c.04.25.25.43.5.43h3.26c.25 0 .46-.18.49-.43l.3-2.16c.52-.23 1-.5 1.42-.82l2.03.81c.22.09.47 0 .59-.22l1.63-2.83c.1-.16.06-.39-.1-.51l-1.72-1.35zM12 15.6c-1.98 0-3.6-1.62-3.6-3.6s1.62-3.6 3.6-3.6 3.6 1.62 3.6 3.6-1.62 3.6-3.6 3.6z" />
    </svg>
  );
};
