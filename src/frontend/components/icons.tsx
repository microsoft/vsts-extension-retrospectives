...
export const GearIcon = () => {
  return (
    <svg className="icon-gear" xmlns="http://www.w3.org/2000/svg" height="24" viewBox="0 0 24 24" width="24" fill="currentColor">
      <path d="M12 10.55c.8 0 1.45.65 1.45 1.45s-.65 1.45-1.45 1.45-1.45-.65-1.45-1.45.65-1.45 1.45-1.45m0-2.9c-2.41 0-4.35 1.94-4.35 4.35s1.94 4.35 4.35 4.35 4.35-1.94 4.35-4.35-1.94-4.35-4.35-4.35m9.06 4.35c0-.17 0-.36-.01-.54l2.81-2.13-3.63-6.28-3.25 1.36c-.29-.19-.61-.38-.93-.54L15.63.4h-7.25l-.44 3.49c-.32.16-.62.35-.93.54L3.76 3.05.13 9.33l2.81 2.13c-.01.17-.01.36-.01.54s0 .36.01.54L.13 14.67l3.63 6.28 3.25-1.36c.29.19.61.38.93.54l.44 3.48h7.25l.44-3.49c.32-.16.62-.33.93-.54l3.25 1.36 3.63-6.28-2.81-2.13c.01-.16.01-.35.01-.52m-2.06 5.28-2.51-1.06c-.81.87-1.89 1.51-3.09 1.78l-.35 2.7h-2.12L10.6 18c-1.2-.28-2.28-.91-3.09-1.78L5 17.28l-1.06-1.84 2.16-1.64q-.26-.85-.26-1.78t.26-1.78L3.94 8.6 5 6.76l2.51 1.06c.81-.87 1.89-1.51 3.09-1.78l.33-2.7h2.13l.33 2.7c1.2.28 2.28.91 3.09 1.78l2.51-1.06 1.06 1.84-2.16 1.64q.26.85.26 1.78t-.26 1.78l2.16 1.64z" />
    </svg>
  );
};
