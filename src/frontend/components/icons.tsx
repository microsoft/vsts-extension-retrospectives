...
export const iconDefinitions: IIconDefinition[] = [
  ...
  { id: "reviews", name: "Reviews", icon: <ReviewsIcon />, trayOrder: 10 },
  { id: "forum", name: "Forum", icon: <ForumIcon />, trayOrder: 11, legacyAliases: ["far fa-comments"] },
  { id: "star", name: "Star", icon: <StarIcon />, trayOrder: 12, legacyAliases: ["far fa-star", "fas fa-star"] },
  { id: "light-bulb", name: "Light Bulb", icon: <LightBulbIcon />, trayOrder: 13, legacyAliases: ["far fa-lightbulb"] },
  { id: "coffee", name: "Coffee", icon: <CoffeeIcon />, trayOrder: 14, legacyAliases: ["fas fa-coffee"] },
  { id: "birthday-cake", name: "Birthday Cake", icon: <BirthdayCakeIcon />, trayOrder: 15, legacyAliases: ["fas fa-birthday-cake"] },
  { id: "play-circle", name: "Play", icon: <PlayCircleIcon />, trayOrder: 16, legacyAliases: ["far fa-circle-play"] },
  { id: "stop-circle", name: "Stop", icon: <StopCircleIcon />, trayOrder: 17, legacyAliases: ["far fa-circle-stop"] },
  { id: "adjust", name: "Target", icon: <AdjustIcon />, trayOrder: 18, legacyAliases: ["far fa-circle-dot", "fa-bullseye"] },
  ...
  { id: "eye", name: "Eye", icon: <EyeIcon />, trayOrder: 24, legacyAliases: ["eye", "far fa-eye"] },
