...
export const iconDefinitions: IIconDefinition[] = [
  ...
  { id: "exclamation", name: "Exclamation", icon: <ExclamationIcon />, trayOrder: 5, legacyAliases: ["fas fa-exclamation", "fas fa-exclamation-triangle", "far fa-exclamation"] },
  { id: "check-circle", name: "Check", icon: <CheckCircleIcon />, trayOrder: 6, legacyAliases: ["fa-check-circle", "far fa-square-check"] },
  ...
  { id: "support", name: "Support", icon: <SupportIcon />, trayOrder: 9, legacyAliases: ["fas fa-life-ring"] },
  ...
  { id: "rocket-launch", name: "Rocket", icon: <RocketLaunchIcon />, trayOrder: 14, legacyAliases: ["fas fa-rocket", "fas fa-fan"] },
  ...
  { id: "plumbing", name: "Plumbing", icon: <PlumbingIcon />, trayOrder: 18, legacyAliases: ["far fa-plumbing", "far fa-wrench", "fas fa-wrench"] },
  { id: "menu-book", name: "Book", icon: <MenuBookIcon />, trayOrder: 19, legacyAliases: ["fas fa-book"] },
  { id: "add-circle", name: "Add Circle", icon: <AddCircleIcon />, trayOrder: 20, legacyAliases: ["fa-plus", "fa-plus-circle", "far fa-square-plus"] },
  { id: "birthday-cake", name: "Birthday Cake", icon: <BirthdayCakeIcon />, trayOrder: 21, legacyAliases: ["fas fa-birthday-cake"] },
  ...
  { id: "search", name: "Search", icon: <SearchIcon />, trayOrder: 24, legacyAliases: ["search", "fa-solid fa-magnifying-glass"] },
  { id: "lock", name: "Lock", icon: <LockIcon />, trayOrder: 25, legacyAliases: ["fas fa-lock"] },
  { id: "electric-bolt", name: "Electric Bolt", icon: <ElectricBoltIcon />, trayOrder: 26, legacyAliases: ["electric-bolt", "fa-solid fa-bolt"] },
  { id: "balance", name: "Balance", icon: <BalanceIcon />, trayOrder: 27, legacyAliases: ["balance", "fas fa-scale-balanced", "fas fa-scale-unbalanced", "fas fa-scale-unbalanced-flip", "fa-solid fa-scale-balanced"] },
  { id: "gear", name: "Gear", icon: <GearIcon />, trayOrder: 28, legacyAliases: ["gear"] },
  { id: "eye", name: "Eye", icon: <EyeIcon />, trayOrder: 29, legacyAliases: ["eye", "far fa-eye"] },
  ...
  { id: "reviews", name: "Reviews", icon: <ReviewsIcon />, trayOrder: 0 },
