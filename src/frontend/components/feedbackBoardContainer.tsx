...
class FeedbackBoardContainer extends React.Component<FeedbackBoardContainerProps, FeedbackBoardContainerState> {
  ...
  // Handle when tab is clicked
  private readonly handleTabClick = async (tabName: 'board' | 'history'): Promise<void> => {
    if (tabName === "board") {
  ...
  private readonly getCurrentBoardPhase = () => {
    return this.state.currentBoard?.activePhase || WorkflowPhase.Collect;
  };
    ...
    return (
      <>
        ...
        <div className="flex">
          <button
            role="tab"
            className="px-3 py-2 text-sm cursor-pointer transition-colors outline-none rounded-t-lg border-x border-t border-b-2 border-[var(--nav-header-active-item-background)]"
            style={{
