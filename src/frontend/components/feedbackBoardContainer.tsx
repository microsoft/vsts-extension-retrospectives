          ...
          {this.state.currentBoard &&
            <>
              <section className="retro-summary-section">
                ...
                <div id="retro-summary-session-date">Created date: {new Intl.DateTimeFormat('en-US', { year: 'numeric', month: 'short', day: 'numeric' }).format(this.state.currentBoard.createdDate)}</div>
