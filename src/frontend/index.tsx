...
sdkInit({ applyTheme: true })
  .then(async () => {
    ...
    root.render(
      <AppInsightsErrorBoundary onError={() => <h1>{t("app_error_boundary_heading")}</h1>} appInsights={reactPlugin}>
        <FeedbackBoardContainer isHostedAzureDevOps={hostedAzureDevOps} projectId={projectId} />
