...
![History tab showing table with 6 columns and 5 rows. Columns include: Retrospective Name, Created Date, Archived, Archived Date, Feedback Items, and Total Work Items. Rows include: 1st Retrospective, 2nd Retrospective, Lean Coffee (archived), 3rd Retrospective, 4th Retrospective.](https://github.com/microsoft/vsts-extension-retrospectives/raw/main/documentation/images/desktop/history-view-with-archive.png)
